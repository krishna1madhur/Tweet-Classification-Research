...
def TrainModel():
    ...
    positivePercent = 33.33*len(ObamaFinalTweets)/100
    negativePercent = 33.33*len(ObamaFinalTweets)/100
    neutralPercent = 33.33*len(ObamaFinalTweets)/100
...
#    saveProcessedTweets(tweetList, labelList)
    ...
    classifier = classifier = svm.LinearSVC(C=0.5,loss='hinge', multi_class ='ovr', penalty ='l2',random_state =42,max_iter=10000 )
