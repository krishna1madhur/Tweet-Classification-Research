...
def TrainModel():
    ...
    positivePercent = 40*len(ObamaFinalTweets)/100
    negativePercent = 40*len(ObamaFinalTweets)/100
    neutralPercent = 20*len(ObamaFinalTweets)/100
...
#    saveProcessedTweets(tweetList, labelList)
    ...
    classifier = svm.LinearSVC(C=0.5,loss='hinge', multi_class ='ovr', penalty ='l2',random_state =42,max_iter=10000 )
